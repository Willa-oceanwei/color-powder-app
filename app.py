...
if tab_name == "customer":
    ...
    # ===== 新增 / 編輯表單 =====
    st.markdown('<h2 style="font-size:22px; font-family:Arial; color:#dbd818;">🤖 新增客戶</h2>', unsafe_allow_html=True)
    col1, col2 = st.columns(2)
    with col1:
