...
# ======== 客戶名單 =========
    ...
    with col1:
        search_recipe_code = st.text_input("配方編號", key="top_search_recipe_code")
    with col2:
        search_customer = st.text_input("客戶名稱或編號", key="top_search_customer")
    with col3:
        search_pantone = st.text_input("Pantone 色號", key="top_search_pantone")
