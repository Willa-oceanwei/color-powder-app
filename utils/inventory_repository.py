...
CARWASH_TRANSFER_NOTE_PREFIX = "洗車廠出庫轉入"


def is_carwash_transfer_inventory_movement(row: dict[str, Any]) -> bool:
    """Return whether an inventory movement was generated by a carwash transfer."""
    note = str(row.get("備註", row.get("notes", "")) or "").strip()
    return note.startswith(CARWASH_TRANSFER_NOTE_PREFIX)
